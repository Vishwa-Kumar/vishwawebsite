                            ...
                            <div class="content section-padding valign">
                                <div class="caption">
                                    ...
                                    <p>I am Vishwa Kumar Deepak. Graduated in Computer Science Engineering from KIIT University Bhubaneswar.
                                     ...
                                     Always eager and curious about technology around.
                                    </p>
                                   

                                    <a target="_blank" href="https://docs.google.com/document/d/1UhOzvWJq2NgnIwoH39frLTkwYajW3a_M6d3PKwDs2w4/edit?usp=sharing" class="butn butn-bg mt-30">
                                        <span>Download C.V</span>
                                    </a>
                                    <div class="social">
                                    <a target="_blank" href="https://www.linkedin.com/in/vishwakumardeepak/" class="icon">
                                            <i class="fab fa-linkedin"></i>
                                        </a>
                                        <a target="_blank" href="https://www.facebook.com/vishusmplydbst" class="icon">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                                        <a target="_blank" href="https://www.instagram.com/vishwa_kumar/" class="icon">
                        ...
                        <div class="col-lg-7">
                            <div class="content section-padding">
                                ...
                                <div class="section-head">
                                    <h5><span>A</span>bout Me</h5>
                                    <h3>About</h3>
                                </div>
                                
                                <div class="text-center">
                                    <h5 class="intro">I am a <b>software engineer</b> from India, Hyderabad.</h5>
                                    <p class="mb-15">Proficient in the data structure, algorithms, design patterns, and other computer science fundamentals. 
                                    Six years plus experience in developing products and hands-on web, cloud, microservice architecture, etc. Presently working with Microsoft on keeping billions of devices running on the Windows operating system up to date and secure</p>
                                    <a target="_blank" href="https://docs.google.com/document/d/1UhOzvWJq2NgnIwoH39frLTkwYajW3a_M6d3PKwDs2w4/edit?usp=sharing" class="butn butn-bg">
                                        <span>Download C.V</span>
                                    </a>
                                        ...
                                        <div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 col-sm-9 right">
                                                    ...
                                                    <p>All the Lorem Ipsum on the Internet tend to repeat chunks as necessary, making this on the Internet generator.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div>
